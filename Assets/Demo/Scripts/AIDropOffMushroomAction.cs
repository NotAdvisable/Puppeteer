...
public class AIDropOffMushroomAction : PuppeteerExecutableAction
{
	public override void Enter(PuppeteerAgent _executingAgent)
	{
		...
		MushroomManager.Instance.AddMushroom(value != null ? value as GameObject : null);
	}
	...
	public override void Exit()
	{
		...
		{
			if(effect.Key != HAS_ENOUGH_MUSHROOMS_KEY)
			{
	...
	private static readonly string HAS_ENOUGH_MUSHROOMS_KEY = "HasEnoughMushrooms";
}